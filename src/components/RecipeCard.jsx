...
const RecipeCard = (props) => {
  ...
  return (
    <Link to={`/recipes/details/${id}`} className="mt-10 block w-[23vw] rounded overflow-hidden shadow">
    <img className="mr-3 mb-3 object-cover w-full h-[20vh]" src={image} alt="" />
